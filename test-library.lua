...
function Library:Notify(Text, Time)
	...
	Library:AddToRegistry(FrameInner, {
		BackgroundColor3 = 'MainColor';
		BorderColor3 = 'OutlineColor';
	});

	local BarSide = Library.NotificationStyle.BarSide or "Left";
	local AccentBar = Library:Create('Frame', {
		BackgroundColor3 = Library.AccentColor;
		BorderSizePixel = 0;
		Position = NotifySettings.BarPosition[BarSide] or NotifySettings.BarPosition["Left"];
		Size = NotifySettings.BarSize[BarSide] or NotifySettings.BarSize["Left"];
		ZIndex = 103;
		Parent = FrameInner;
	});
