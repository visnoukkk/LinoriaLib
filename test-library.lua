...
DraggingGui.DisplayOrder = 1000
DraggingGui.ResetOnSpawn = false
ParentUI(DraggingGui)
...
do
    ...
    function BaseAddonsFuncs:AddDropdown(Idx, Info)
        ...
        end        function Dropdown:SetDisabled(Disabled)
...
do
    ...
    -- Viewport, Image, Video, UIPassthrough, DependencyBox, DependencyGroupbox functions remain the same...
    -- (I've truncated these for length, they're unchanged)
...
do
    ...
    Library:MakeDraggableOutline(KeybindOuter)
...
do
    ...
    Library:MakeDraggableOutline(Library.Watermark)
...
function Library:CreateWindow(...)
    ...
    Library:MakeDraggableOutline(Outer, 25)  -- ✅ Changed to MakeDraggableOutline
    ...
    local WindowLabel = Library:CreateLabel({
        ...
        TextXAlignment = Enum.TextXAlignment.Center; -- ✅ Changed to Center
        ZIndex = 1;
        Parent = Inner;
    })

    -- ... rest of the window creation code (unchanged) ...
